...
<script>
	...
	Tag로 둘러싸인 모든 속성은 하나의 ㄱ개체가 된다
	
	HTML문서의 모든 객체의 시작점 객체는 document
...
<nav id="main">
	<ul>
		...
		a tag를 사용하지 않고 메뉴 등을 구성했을때는
		스크립트를 사용하여 "메뉴 클릭 점프" 기능을 
		구현해야 하는 문제가 발생한다
		
		최근에 유행하는 UI/UX는 그러한 스크립트를 사용해야
		함에도 불구하고 a tag 사용을 하지 않는 방식을 많이 사용한다
